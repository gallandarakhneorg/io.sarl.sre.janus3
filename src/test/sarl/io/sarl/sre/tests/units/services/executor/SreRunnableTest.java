 ...
 */
public class SreRunnableTest extends AbstractSreTest {
	...
	public void run_logger_successTask() throws Exception {
		...
		SreRunnable runnable = new SreRunnable(() -> {run.set(true);}, this.logger);
		runnable.run();
	...
	public void run_logger_earlyExit1() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {run.set(true); ExecutorService.neverReturn();}, this.logger);
		runnable.run();
		assertTrue(runnable.isSuccess());
		assertTrue(run.get());
		verifyNoMoreInteractions(this.logger);
	...
	public void run_logger_earlyExit2() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {ExecutorService.neverReturn(); run.set(true);}, this.logger);
		runnable.run();
		assertTrue(runnable.isSuccess());
		assertFalse(run.get());
		verifyNoMoreInteractions(this.logger);
	...
	public void run_logger_exception() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {run.set(true); throw new IllegalStateException();}, this.logger);
		runnable.run();
	...
	public void run_noLogger_successTask() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {run.set(true);}, null);
		runnable.run();
		assertTrue(runnable.isSuccess());
		assertTrue(run.get());
		verifyNoMoreInteractions(this.logger);
	...
	public void run_noLogger_earlyExit1() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {run.set(true); ExecutorService.neverReturn();}, null);
		runnable.run();
		assertTrue(runnable.isSuccess());
		assertTrue(run.get());
		verifyNoMoreInteractions(this.logger);
	...
	public void run_noLogger_earlyExit2() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {ExecutorService.neverReturn(); run.set(true);}, null);
		runnable.run();
		assertTrue(runnable.isSuccess());
		assertFalse(run.get());
		verifyNoMoreInteractions(this.logger);
	...
	public void run_noLogger_exception() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreRunnable runnable = new SreRunnable(() -> {run.set(true); throw new IllegalStateException();}, null);
		try {
			runnable.run();
