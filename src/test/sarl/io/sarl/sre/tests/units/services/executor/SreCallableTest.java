...
public class SreCallableTest extends AbstractSreTest {
	...
	public void call_logger_successTask() throws Exception {
		...
		SreCallable<String> callable = new SreCallable<>(() -> {run.set(true); return "a";}, this.logger);
	...
	public void call_logger_earlyExit1() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable<>(() -> {run.set(true); ExecutorService.neverReturn(); return "b";}, this.logger);
		String value = callable.call();
		assertTrue(callable.isSuccess());
		assertNull(value);
		assertTrue(run.get());
	...
	public void call_logger_earlyExit2() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable<>(() -> {ExecutorService.neverReturn(); run.set(true); return "c";}, this.logger);
		String value = callable.call();
		assertTrue(callable.isSuccess());
		assertNull(value);
		assertFalse(run.get());
	...
	public void call_logger_exception() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable<>(() -> {run.set(true); throw new IllegalStateException();}, this.logger);
		String value = callable.call();
	...
	public void call_noLogger_successTask() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable<>(() -> {run.set(true); return "d";}, null);
		String value = callable.call();
		assertTrue(callable.isSuccess());
	...
	public void call_noLogger_earlyExit1() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable<>(() -> {run.set(true); ExecutorService.neverReturn(); return "e";}, null);
		String value = callable.call();
		assertTrue(callable.isSuccess());
		assertNull(value);
		assertTrue(run.get());
	...
	public void call_noLogger_earlyExit2() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable<>(() -> {ExecutorService.neverReturn(); run.set(true); return "f";}, null);
		String value = callable.call();
		assertTrue(callable.isSuccess());
		assertNull(value);
		assertFalse(run.get());
	...
	public void call_noLogger_exception() throws Exception {
		AtomicBoolean run = new AtomicBoolean();
		SreCallable<String> callable = new SreCallable(() -> {run.set(true); throw new IllegalStateException();}, null);
		try {
			callable.call();
