...
import io.janusproject.sre.services.executor.AbstractExecutorService;
...
public abstract class AbstractExecutorServiceTest<T extends AbstractExecutorService> extends AbstractJanusTest {
	...
	public void neverReturn_noPostCommand() {
		io.janusproject.sre.services.executor.ExecutorService.neverReturn();
	}
	...
	public void getServiceType() {
		assertEquals(io.janusproject.sre.services.executor.ExecutorService.class, this.service.getServiceType());
	}
