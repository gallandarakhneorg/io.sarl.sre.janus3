...
import io.janusproject.sre.services.executor.QuietThreadExecutorPolicy;
...
@RunWith(Suite.class)
@SuiteClasses({
	QuietThreadExecutorPolicyTest.NotShutDownTest.class,
	QuietThreadExecutorPolicyTest.ShutDownTest.class
})
...
public class QuietThreadExecutorPolicyTest {
	...
	public static class NotShutDownTest extends AbstractJanusTest {
		...
		@Nullable
		private QuietThreadExecutorPolicy handler;
