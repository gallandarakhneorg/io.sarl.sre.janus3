...
import io.janusproject.sre.spaces.JanusEventSpaceSpecification;
...
@ManualMocking
public class JanusEventSpaceSpecificationTest extends AbstractJanusTest {
	...
	@InjectMocks
	private JanusEventSpaceSpecification specification;

	@Before
	public void setUp() {
		this.spaceId = new SpaceID(UUID.randomUUID(), UUID.randomUUID(), EventSpaceSpecification.class);
		MockitoAnnotations.initMocks(this);
		this.specification = new JanusEventSpaceSpecification(this.injector);
	}
