...
class NoChildInnerContextIsKillableTestAgent extends Agent {
  @Override
  ...
  @SyntheticMember
  public NoChildInnerContextIsKillableTestAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public NoChildInnerContextIsKillableTestAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public NoChildInnerContextIsKillableTestAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
