...
class RegisteredInInitializeAgent extends Agent {
  ...
  protected boolean runAgentTest() {
    throw new Error("Unresolved compilation problems:"
      ...
      + "\nThe field RegisteredInInitializeAgent.behavior refers to the missing type MyBehavior"
      + "\nThe field RegisteredInInitializeAgent.behavior refers to the missing type MyBehavior"
      + "\nThe field RegisteredInInitializeAgent.behavior refers to the missing type MyBehavior");
  }
  ...
  @SyntheticMember
  public RegisteredInInitializeAgent(final UUID parentID, final UUID agentID) {
  ...
  @Inject
  @Deprecated
  public RegisteredInInitializeAgent(final BuiltinCapacitiesProvider provider, final UUID parentID, final UUID agentID) {
    super(provider, parentID, agentID);
  }
  
  @SyntheticMember
  @Inject
  public RegisteredInInitializeAgent(final UUID parentID, final UUID agentID, final DynamicSkillProvider skillProvider) {
